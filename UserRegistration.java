...
public class UserRegistration {
	...
	/**
	 * Method to check given email samples are valid or invalid all email samples
	 * are passed to array and checking through for loop iteration if email passes
	 * the regex expression then it is valid email or else Invalid email
	 */
	public void sampleEmails() {
		String[] emails = { "abc@yahoo.com", "abc-100@yahoo.com", "abc.100@yahoo.com", "abc111@abc.com",
				...
				"abc()*@gmail.com", "abc@%*.com", "abc..2002gmail.com", "abc.@gmail.com", "abc@abc@gmail.com",
		...
		for (int i = 0; i < emails.length; i++) {
			/*
			 * Defined a expression for validation of email created a pattern and matcher to
			 * check sample arrays
			 */
